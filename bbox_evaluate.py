...
parser.add_argument("--input_file", type=str, default="pipeline_outputs/bbox_hallucinations_hth_0.5_mth_0.3_cog_vlm.jsonl", help="Path to the JSONL file containing generated captions by the VLM.")
